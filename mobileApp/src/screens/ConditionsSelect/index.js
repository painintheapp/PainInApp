    ...
    return (
        <View style={styles.container}>
            ...
            <HeaderView
                ...
                image2={setting}
            />
            <Text style={[styles.headerText, { marginVertical: 10 }]}>Conditions</Text>
            <Text style={[styles.headerText, { fontSize: 15 }]}>Hi Patty,which condition(s) are you dealing with?</Text>
            ...
            <View style={styles.ButtonView}>
                <Button
                    ...
                    onPress={() => navigation.navigate('MoreConditions')}
