    ...
    return (
        <View style={styles.container}>
          <HeaderView
            ...
            <Text style={[styles.headertext,{fontSize:15,marginVertical:0}]}>Sleep Quality-Weekly Metrics</Text>
            ...
            <View style={styles.drView}>
                <View style={styles.drimageView}>
                    ...
                    />
                    <Text style={{ marginLeft:10,fontSize:15 }}>Chropractor</Text>
                </View>
                <Text style={{ padding:10 }}>Your poor sleep can attribute to your sensation in the neck. Try to sleep facing up to alliviate pain.</Text>
