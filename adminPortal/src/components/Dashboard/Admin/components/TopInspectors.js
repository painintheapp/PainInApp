...
const TopInspectors = ({topInspector}) => {
    ...
    return (
        <div>
            <h4 className="gx-font-sans-bold gx-blue-font gx-pl-2">Top Inspectors</h4>
            <Table className="borderLessTable" dataSource={topInspector} columns={columns}  bordered={false} pagination={{
                    total: 3,
                    pageSize: 3,
