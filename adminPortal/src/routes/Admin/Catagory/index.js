...
import CatagoryTable from "components/Table/List";
import IntlMessages from 'util/IntlMessages'
import SelectFilter from 'components/Filters/SelectFilter'
import DeleteConfirm from 'components/Modal/DeleteConfirm';
import EditModal from '../Catagory/components/EditCatagory'
import TableAction from 'components/Table/Actions'
import AddNewCatagory from '../Catagory/components/AddNewCatagory'
...
const Catagory = () => {
    ...
    const columns = [
        {
            ...
            render: (record) => <span>{record.catagoryNo}</span>,
            key: "catagoryNo",
        },
        {
            title: <IntlMessages id="catagory.catagory" />,
            render: (record) => <span>{record.catagoryName}</span>,
            key: "catagoryName",
        },
        {
            title: <IntlMessages id="catagory.subcatagory" />,
    ...
    return (
        <Layout>
            <Widget
                ...
                title={
                    <h4
                        ...
                        style={{ color: "#14244E" }}>
                        <IntlMessages id="catagory.pageTitle" />
                    </h4>
                }
                extra={
            ...
            >
                <CatagoryTable apiName="getCatagory"  scroll={true} pagination={true} columns={columns} />
            </Widget>
            <EditModal/>
        </Layout>
    )
