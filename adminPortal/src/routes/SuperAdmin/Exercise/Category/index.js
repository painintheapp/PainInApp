...
const Category = () => {
    ...
    const columns = [
        ...
        {
            title: <IntlMessages id="catagory._id" />,
            ...
            <Widget
                ...
                extra={
                    <div className="gx-d-flex" style={{gap : '10px'}}>
                        ...
                        <UploadCSV type="getAllSkills" url="bulkImportSkills" table="ExerciseCategory"/>
                        <AddNewCategory />
                    </div>}
            >
                <CategoryTable apiName="getExerciseCategory"  scroll={true} pagination={true} columns={columns} />
            </Widget>
            <EditModal/>
        </Layout>
    )
